  ...
  return (
    <main className="ml-3 xl:ml-7 mb-7">
      <div className="flex flex-col justify-start items-start border-b border-gray-500 w-[70vw] mb-7">
        <h1 className="text-lg md:text-2xl font-bold">Edit Member</h1>
        <p className="text-xs md:text-base text-gray-600">ID: {member.id}</p>
      </div>
      ...
      >
        <Card className="w-full h-full">
          <CardHeader>
            ...
            <CardDescription>
              Fill out the required fields below to update your Member.
            </CardDescription>
          </CardHeader>
