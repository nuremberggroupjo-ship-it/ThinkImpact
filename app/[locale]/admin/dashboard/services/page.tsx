...
export default async function ServicesTable() {
  ...
  return (
    <>
      <Head>
        <title>Services - Think Impact</title>
        <meta
          name="description"
          content="View and manage all services offered in Think Impact's consulting programs."
        />
        <link
          rel="canonical"
          href={process.env.NEXT_PUBLIC_APP_URL + "/admin/dashboard/services"}
        />

        {/* Open Graph / Social Sharing */}
        <meta property="og:title" content="Services - Think Impact" />
        <meta
        ...
        <meta
          property="og:url"
          content={process.env.NEXT_PUBLIC_APP_URL + "/admin/dashboard/services"}
        />
        <meta
          property="og:image"
