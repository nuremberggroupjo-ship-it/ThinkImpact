...
export default async function ConsultingTable() {
  ...
  return (
    <>
      <Head>
        <title>Think Impact - Consulting Categories</title>
        <meta
          name="description"
          content="View and manage all consulting categories in Think Impact. Add, edit, or delete categories to organize your services."
        />
        <link
          rel="canonical"
          href={`${process.env.NEXT_PUBLIC_APP_URL}/admin/dashboard/consulting`}
        />

        {/* Open Graph */}
        <meta property="og:title" content="Think Impact - Consulting Categories" />
        <meta
        ...
        <meta
          property="og:url"
          content={`${process.env.NEXT_PUBLIC_APP_URL}/admin/dashboard/consulting`}
        />
        <meta
          property="og:image"
