...
export default async function trainingTable() {
  ...
  return (
    <>
      <Head>
        <title>Training List - Think Impact</title>
        <meta
          name="description"
          content="View, edit, and manage all training programs in the Think Impact dashboard."
        />
        <link
          rel="canonical"
          href={process.env.NEXT_PUBLIC_APP_URL + "/admin/dashboard/training"}
        />

        {/* Open Graph */}
        <meta property="og:title" content="Training List - Think Impact" />
        <meta
        ...
        <meta
          property="og:url"
          content={process.env.NEXT_PUBLIC_APP_URL + "/admin/dashboard/training"}
        />
        <meta
          property="og:image"
