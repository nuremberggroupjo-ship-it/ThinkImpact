...
export default async function ClientsTable() {
  ...
  return (
    <>
      <Head>
        <title>Think Impact - Clients</title>
        <meta
          name="description"
          content="View and manage all clients of Think Impact. Edit, delete, or add new clients to the system."
        />
        <link
          rel="canonical"
          href={`${process.env.NEXT_PUBLIC_APP_URL}/admin/dashboard/clients`}
        />

        {/* Open Graph / Social Sharing */}
        <meta property="og:title" content="Think Impact - Clients" />
        <meta
        ...
        <meta
          property="og:url"
          content={`${process.env.NEXT_PUBLIC_APP_URL}/admin/dashboard/clients`}
        />
        <meta
          property="og:image"
